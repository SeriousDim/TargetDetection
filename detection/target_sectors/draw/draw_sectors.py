...
def draw_circle_sector(image, box: Geometry, sector: CircleSector):
    ...
    draw.ellipse([x1, y1, x2, y2], outline=(255, 0, 0), width=SectorConfig.line_width)
...
def draw_angle_sector(image, box: Geometry, sector: AngleSector):
    ...
    draw.line([x0, y0, x1, y1], fill=(255, 0, 0), width=SectorConfig.line_width)
    draw.line([x0, y0, x2, y2], fill=(255, 0, 0), width=SectorConfig.line_width)
